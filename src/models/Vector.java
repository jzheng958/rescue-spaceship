...
/**
 * A simple geometric vector class (a la Point), which allows doubles for its
 * fields
 */
public class Vector {
	private double x;
	...
	/** Add v's components to this vector and return this Vector */
	...
	/**
	 * Multiply both of this vector's components by s and return this Vector.
	 */
	...
	/**
	 * Invert both of this' components ---change this vector to 1/x, 1/y--- and
	 * return this Vector. Precondition: the x and y components are not 0.
	 */
	...
	/**
	 * Make this vector have length 1, with the same direction, and return this
	 * Vector.
	 */
	public Vector unit() {
		double l= length();
	...
	/**
	 * Return the cross product of a and b. Because vectors are 2-d, the return
	 * is a vector of the form 0, 0, z So a 1-D vector.
	 */
	...
	/**
	 * Return the angle between a and b, in radians. Return is in the range 0..
	 * PI
	 */
	...
	/**
	 * Return the angle between this and b, in radians. Return is in the range 0
	 * .. PI
	 */
	...
	/**
	 * Hash a vector based on its components, using function Objects.hash. Round
	 * both components to the nearest TOLERANCE
	 */
	@Override
	public int hashCode() {
	...
	/**
	 * Return true iff ob is a Vector and is equal to this one. Two vectors are
	 * equal if their components are equal - thus checks if they have the same
	 * hashcodes, which are built off of their components
	 */
	@Override
